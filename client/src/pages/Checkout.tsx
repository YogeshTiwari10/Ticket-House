...
const Checkout = () => {
  ...
  const submitMovieOrder =  () => {
    ...
    //   orderTotal,
    // };
    // setStripeData(movieShowDetails)
  ...
  const makePayment = async ()=>{
    ...
    const result = stripe!.redirectToCheckout({
      ...
      // console.log("save data", submitMovieOrder())
            ...
            <div className='movie-price-summary'>
              ...
              <div className='movie-price-det'>
                ...
                <span className='movie-price-det-value font-weight-bold'>
                  ...
                  {/* {console.log(orderTotal.toFixed(2).toString().split(''))} */}
                </span>
              </div>
            </div>
          </div>
